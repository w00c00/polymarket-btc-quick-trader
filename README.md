...
- Paper-runs consecutive next-15m strategy rounds with a configurable pre-open decision window, entry cap, 0.60-style take profit, round count, time limit, stop button, and result notification.
